...
# Edge Impulse library for kws-yes_no

This is a C++ library that lets you run the impulse for "kws-yes_no" (http://localhost:4800/studio/299971) on any device. It consists of the Edge Impulse inferencing SDK - with implementations of both processing and learning blocks - and your model. You will need to include this library in your project to run your impulse locally.
